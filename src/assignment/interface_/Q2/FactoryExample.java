...
public class FactoryExample {
    ...
    public void getResult(Factory mainFactory, char mainFactorySkill, WorkingTogether partner) {
        ...
        Factory partner1 = (Factory) partner;
        System.out.println("2. 파트너공장 [" + partner1.getFactoryName() + "] 협력 시 추가 생산량 = " + partner.workTogether(partner) );
        System.out.println("--------------------------------------------------------------");
    }
}
